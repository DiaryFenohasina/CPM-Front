<template>
  <i :class="[
    'position-absolute bg-primary text-white p-1 fs-4 rounded',
    props.collapsed ? 'bi bi-caret-right-fill' : 'bi bi-caret-left-fill'
  ]" style="z-index: 999; right: -15px; top: 10px; cursor: pointer;" @click="toggleSidebar" />
  <div class="container-fluid shadow-sm bg-light p-2 h-100">
    <div :class="[props.collapsed ? 'd-none' : 'd-block']">
      ...
      <div class="tasks-list p-2 my-4 ">
        ...
        <div class="table-responsive mb-3" style="max-height: 600px;">
